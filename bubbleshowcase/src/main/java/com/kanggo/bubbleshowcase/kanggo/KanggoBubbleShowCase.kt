...
class KanggoBubbleShowCase(builder: KanggoBubbleShowCaseBuilder) {
    ...
    private val mButtonTitle: String? = builder.mButtonTitle
    private val mButtonVisibility: Boolean? = builder.mButtonVisibility
    ...
    private val mHighlightMode: KanggoBubbleShowCase.HighlightMode? = builder.mHighlightMode
    ...
    private var bubbleMessageViewBuilder: KanggoBubbleMessageView.Builder? = null
    ...
    private fun getBubbleMessageViewBuilder(): KanggoBubbleMessageView.Builder {
        return KanggoBubbleMessageView.Builder()
            .from(mActivity)
            ...
            .buttonTitle(mButtonTitle ?: "OK")
            .buttonVisibility(mButtonVisibility ?: false)
            .title(mTitle)
            .subtitle(mSubtitle)
            .listener(object : OnBubbleMessageViewListener {
                override fun onBubbleClick() {
                    mBubbleShowCaseListener?.onBubbleClick(this@KanggoBubbleShowCase)
                }

                override fun onCloseActionImageClick() {
                    dismiss()
                    mBubbleShowCaseListener?.onCloseActionImageClick(this@KanggoBubbleShowCase)
                }
            })
    }
    ...
    private fun addBubbleMessageViewDependingOnTargetView(
        targetView: View?,
        bubbleMessageViewBuilder: KanggoBubbleMessageView.Builder,
        backgroundDimLayout: RelativeLayout?
    ) {
        if (targetView == null) return
    ...
    private fun addBubbleMessageViewOnScreenCenter(
        ...
        val bubbleMessageView: KanggoBubbleMessageView = bubbleMessageViewBuilder.build()
        bubbleMessageView.id = createViewId()
